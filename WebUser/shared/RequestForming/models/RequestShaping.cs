...
{
    public static class RequestShaping
    {
        public static IQueryable<T> Filter<T>(IQueryable<T> source, Expression<Func<T, bool>> filterExpression) => source.Where(filterExpression);
