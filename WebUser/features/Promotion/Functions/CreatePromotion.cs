        ...
        public class Handler : IRequestHandler<CreatePromotionCommand, PromotionDTO>
        {
            ...
            public async Task<PromotionDTO> Handle(CreatePromotionCommand request, CancellationToken cancellationToken)
            {
                ...
                var promotionProducts = products
                    ...
                    .ToList();
                promotion.ConditionProducts = promotionProducts;
                ...
                var promotionPromProducts = promProducts
                    ...
                    .ToList();
                promotion.ActionProducts = promotionPromProducts;
                ...
                var promotionDTO = new PromotionDTO
                {
                    ...
                    PromoProducts = promotion
                        .ActionProducts.Select(pp => new ProductMinDTO
                        {
                            ID = pp.Product.ID,
                    ...
                    Products = promotion
                        .ConditionProducts.Select(p => new ProductMinDTO
                        {
                            ID = p.Product.ID,
                            Name = p.Product.Name,
                    ...
                    AttributeValues = promotion.AttributeValues.GroupBy(av => av.AttributeValue.AttributeName)
